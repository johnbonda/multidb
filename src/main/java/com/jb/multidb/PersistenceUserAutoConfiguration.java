...
@EnableJpaRepositories(basePackages = "com.jb.multidb.db1", entityManagerFactoryRef = "userEntityManager", transactionManagerRef = "userTransactionManager")
public class PersistenceUserAutoConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean userEntityManager() {
        ...
        em.setPackagesToScan("com.jb.multidb.db1");
